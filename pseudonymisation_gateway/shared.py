...
HONORIFICS = {
    ...
    "Hon", "Honorable", "Honourable", "Justice", "Judge",
    "Adv", "Advocate", "Atty", "Attorney", "Sir", "Madam", "Madame",
    # Arabic / Gulf context
    "Sheikh", "Sayed", "Sayyid", "Hajj", "Hajja",
    # South Asian context
    "Shri", "Smt", "Sri", "Md", "Mohd", "Mohammed",
    # European context
    "Herr", "Frau", "Monsieur", "Madame", "Signor", "Signora",
    "Don", "Doña", "Senhor", "Senhora",
}
